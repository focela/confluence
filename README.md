...
```shell
git clone https://github.com/powaline/postgres-backup.git \
    && cd postgres-backup \
    && cp .env.example .env
```
...
services:
  ...
  backup:
    ...
    restart: always
    image: powaline/postgres-backup:16
    environment:
      - TZ=${TZ:-UTC}
...
<table>
  <td align="center" valign="top" width="14.28%">
    ...
    <br />
    <a href="https://github.com/powaline/postgres-backup/commits?author=trants" title="Code">💻</a>
    <a href="https://github.com/powaline/postgres-backup/commits?author=trants" title="Documentation">📝</a>
  </td>
</table>
